...
echo "Sem aspas, expressões simples:"
echo -ne "! test $var -eq $var; echo $?\t"; ! test $var -eq $var; echo $?	# 0 ; var="z",z 2 esperava expressão de número inteiro
echo -ne "\t"; ! test $var -ne $var; echo $?	# 1	; var="z",z 2 esperava expressão de número inteiro
echo -ne "\t"; ! test $var -eq $var; echo $?	# 1	; var="z",z 2 esperava expressão de número inteiro
echo -ne "\t"; ! test $var -ne $var; echo $?	# 1	; var="z",z 2 esperava expressão de número inteiro

echo -e "\nCom aspas, expressões simples:"
echo -ne "! test "$var" -eq "$var"; echo $?\t"; ! test "$var" -eq "$var"; echo $? #0;var=" ","z","",z,nul 2 espera expres núm inteiro
echo -ne "\t"; ! test "$var" -ne "$var"; echo $?	#1 ; var=" ","z","",z,nul 2 espera expres núm inteiro
echo -ne "\t"; ! test "$var" -eq "$var"; echo $?	#1 ; var=" ","z","",z,nul 2 espera expres núm inteiro
echo -ne "\t"; ! test "$var" -ne "$var"; echo $?	#1 ; var=" ","z","",z,nul 2 espera expres núm inteiro
