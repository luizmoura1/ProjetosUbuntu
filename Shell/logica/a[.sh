...
#echo -ne "[ \$var == \$var ] -a [ \$var == \$var ]; echo \$?\t"; [ $var == $var ] -a [ $var == $var ]; echo $?	# 2	número excessivo de argumentos
#echo -ne "[ \$var == \$var ] -a [ \$var != \$var ]; echo \$?\t"; [ $var == $var ] -a [ $var != $var ]; echo $?	# 2	número excessivo de argumentos
#echo -ne "[ \$var != \$var ] -a [ \$var == \$var ]; echo \$?\t"; [ $var != $var ] -a [ $var == $var ]; echo $?	# 2	número excessivo de argumentos
#echo -ne "[ \$var != \$var ] -a [ \$var != \$var ]; echo \$?\t"; [ $var != $var ] -a [ $var != $var ]; echo $?	# 2	número excessivo de argumentos
echo "Sem aspas, expressão composta:"
echo -ne "[ \$var == \$var -a \$var == \$var ]; echo \$?\t"; [ $var == $var -a $var == $var ]; echo $?	# 0
echo -ne "[ \$var == \$var -a \$var != \$var ]; echo \$?\t"; [ $var == $var -a $var != $var ]; echo $?	# 1
echo -ne "[ \$var != \$var -a \$var == \$var ]; echo \$?\t"; [ $var != $var -a $var == $var ]; echo $?	# 1
echo -ne "[ \$var != \$var -a \$var != \$var ]; echo \$?\t"; [ $var != $var -a $var != $var ]; echo $?	# 1
